...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname e173_remove_articles) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp")) #f)))
    ...
    [else
     (cond
       [(or
         ...
         (empty? (first line)))
        (string-append "" (process-line (rest line)))]
       [else
