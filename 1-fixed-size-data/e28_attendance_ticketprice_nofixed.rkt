...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname e28_attendance_ticketprice_nofixed) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp")) #f)))
